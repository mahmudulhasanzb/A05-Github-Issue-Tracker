...
- 1️⃣ What is the difference between var, let, and const?
  - var is a traditional variable.
    var and let can be change while 'const' can't change. in modern js (ES6) we should use 'let' for changeble variable instead of var and const for non changeble variable.
...
- 3️⃣ What is the difference between map(), filter(), and forEach()?
  -  map creates a new array by transforming each element of the original array.
    filter retruns a a new array containing only the elements that statisfy a specific condition. forEach simply iterates over each elements and performs a side effect, without returning a new array.
